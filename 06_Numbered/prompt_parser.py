...
!start: (prompt | /[][():]/+)*
prompt: (emphasized | scheduled | grouped | alternate | alternate1 | alternate2 |  sequence | compound | numbered | plain | WHITESPACE)*
...
sequence: prompt "::" (sequence | prompt (","|WHITESPACE)* ";")* "_;" // nested sequences must be implicitly closed with ";" and the last "_;" closes the entire sequence. sequence starts with "::" and ends with ";" or "_;"
